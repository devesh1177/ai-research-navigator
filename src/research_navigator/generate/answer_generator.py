...
def generate_answer(
    ...
    if not results:
        return "I don't have enough relevant material in the corpus to answer this confidently."
    ...
    for citation in citations:
        citation_lookup[citation["doc_id"]] = citation["citation_id"]
    ...
    for result in results:
        ...
        citation_id = citation_lookup[payload["doc_id"]]
